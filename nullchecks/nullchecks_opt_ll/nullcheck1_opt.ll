...
NotNullBB27:                                      ; preds = %NotNullBB25
  ...
  %IsNull30 = icmp eq i32* %arrayidx4, null
...
if.end:                                           ; preds = %NotNullBB29, %NotNullBB23
  %IsNull32 = icmp eq i32** %ptr, null
  br i1 %IsNull32, label %NullBB, label %NotNullBB31

NotNullBB31:                                      ; preds = %if.end
  %8 = load i32*, i32** %ptr, align 8
  %IsNull34 = icmp eq i32* %8, null
  br i1 %IsNull34, label %NullBB, label %NotNullBB33

NotNullBB33:                                      ; preds = %NotNullBB31
  %arrayidx5 = getelementptr inbounds i32, i32* %8, i64 0
  %IsNull36 = icmp eq i32* %arrayidx5, null
...
NullBB:                                           ; preds = %NotNullBB33, %NotNullBB31, %if.end, %NotNullBB27, %NotNullBB25, %if.else, %NotNullBB21, %NotNullBB19, %NotNullBB17, %if.then, %NotNullBB13, %NotNullBB11, %NotNullBB9, %NotNullBB7, %NotNullBB5, %NotNullBB3, %NotNullBB1, %NotNullBB, %entry
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @0, i32 0, i32 0))
  ret void
}
