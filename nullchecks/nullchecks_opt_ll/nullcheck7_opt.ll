; ModuleID = 'nullcheck7.bc'
source_filename = "nullcheck7.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@gvar = dso_local global i32* null, align 8
...
if.else:                                          ; preds = %NotNullBB15
  br i1 false, label %NullBB, label %NotNullBB25

NotNullBB25:                                      ; preds = %if.else
  %7 = load i32*, i32** @gvar, align 8
  %IsNull27 = icmp eq i32** %ptr, null
  br i1 %IsNull27, label %NullBB, label %NotNullBB26

NotNullBB26:                                      ; preds = %NotNullBB25
  store i32* %7, i32** %ptr, align 8
  %IsNull29 = icmp eq i32** %ptr, null
  br i1 %IsNull29, label %NullBB, label %NotNullBB28

NotNullBB28:                                      ; preds = %NotNullBB26
  %8 = load i32*, i32** %ptr, align 8
  %IsNull31 = icmp eq i32* %8, null
  br i1 %IsNull31, label %NullBB, label %NotNullBB30

NotNullBB30:                                      ; preds = %NotNullBB28
  %arrayidx4 = getelementptr inbounds i32, i32* %8, i64 0
  %IsNull33 = icmp eq i32* %arrayidx4, null
  br i1 %IsNull33, label %NullBB, label %NotNullBB32

NotNullBB32:                                      ; preds = %NotNullBB30
  store i32 100, i32* %arrayidx4, align 4
  br label %if.end

if.end:                                           ; preds = %NotNullBB32, %NotNullBB23
  %IsNull35 = icmp eq i32** %ptr, null
  br i1 %IsNull35, label %NullBB, label %NotNullBB34

NotNullBB34:                                      ; preds = %if.end
  %9 = load i32*, i32** %ptr, align 8
  %IsNull37 = icmp eq i32* %9, null
  br i1 %IsNull37, label %NullBB, label %NotNullBB36

NotNullBB36:                                      ; preds = %NotNullBB34
  %arrayidx5 = getelementptr inbounds i32, i32* %9, i64 0
  %IsNull39 = icmp eq i32* %arrayidx5, null
  br i1 %IsNull39, label %NullBB, label %NotNullBB38

NotNullBB38:                                      ; preds = %NotNullBB36
  store i32 100, i32* %arrayidx5, align 4
  ret void

NullBB:                                           ; preds = %NotNullBB36, %NotNullBB34, %if.end, %NotNullBB30, %NotNullBB28, %NotNullBB26, %NotNullBB25, %if.else, %NotNullBB21, %NotNullBB19, %NotNullBB17, %if.then, %NotNullBB13, %NotNullBB11, %NotNullBB9, %NotNullBB7, %NotNullBB5, %NotNullBB3, %NotNullBB1, %NotNullBB, %entry
