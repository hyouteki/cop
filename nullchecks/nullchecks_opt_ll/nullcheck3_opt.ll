; ModuleID = 'nullcheck3.bc'
source_filename = "nullcheck3.c"
...
define dso_local i32* @bar(i32 %size) #0 {
entry:
  %size.addr = alloca i32, align 4
  %IsNull = icmp eq i32* %size.addr, null
...
NotNullBB25:                                      ; preds = %if.else
  store i32* %call4, i32** %ptr, align 8
...
NullBB:                                           ; preds = %NotNullBB35, %NotNullBB33, %if.end, %NotNullBB29, %NotNullBB27, %NotNullBB25, %if.else, %NotNullBB21, %NotNullBB19, %NotNullBB17, %if.then, %NotNullBB13, %NotNullBB11, %NotNullBB9, %NotNullBB7, %NotNullBB5, %NotNullBB3, %NotNullBB1, %NotNullBB, %entry
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @1, i32 0, i32 0))
  ret void
}
